...
export default function SingleInventaris(props) {
        ...
        <DashboardLayout props={props}>
            ...
            <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div className="p-6 bg-white border-b border-gray-200">
                    <h1 className="text-xl font-semibold">Data Inventaris: <span className="text-sky-500">{props.data.nama}</span></h1>
                </div>
            </div>
            ...
            <div className="bg-white mt-6 overflow-hidden shadow-sm sm:rounded-lg">
                <div className="p-6 bg-white border-b border-gray-200 space-y-4">
                    <img src={image} className="rounded-md w-[500px] mb-10 block mx-auto" alt="Inventaris Image"/>
