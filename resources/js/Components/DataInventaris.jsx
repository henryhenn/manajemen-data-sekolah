...
export default function DataInventaris({data}) {
        ...
        <div className="overflow-x-scroll">
            <table className="table mt-6 text-center table-compact w-full">
                ...
                <tr>
                    ...
                    <th>Status</th>
                    {route().current('inventaris.index') ? (
                        <th>Aksi</th>
                    ) : ('')}
                </tr>
                </thead>
                ...
                {data.inventaris.length > 0 ? data.inventaris.map((data, key) => {
                    return (
                        <tr key={key}>
                            ...
                            <th className="p-auto">
                                <img src={image} alt="Gambar Inventaris" className="rounded-md w-auto"/>
                            </th>
