...
export default function Authenticated({ auth, header, children, app_logo }) {
            ...
            <nav className="bg-white border-b border-gray-100">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            <div className="shrink-0 flex items-center">
                                <Link href="/">
                                    <ApplicationLogo logo={app_logo} className="block h-9 w-auto text-gray-500" />
                                </Link>
                            </div>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('siswa.index')} active={route().current('siswa.*')}>
                            Data Siswa
                        </ResponsiveNavLink>
                        <ResponsiveNavLink href={route('guru.index')} active={route().current('guru.*')}>
                            Data Guru
                        </ResponsiveNavLink>
